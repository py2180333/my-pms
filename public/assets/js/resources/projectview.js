$(document).ready(function () {
    ...
    function setDataFromUrl() {
        ...
        const customer = urlParams.get('customer_id'); // Retrieve customer from the URL
    ...
    function fetchProjects() {
        ...
        $.ajax({
            ...
            success: function (response) {
                    ...
                    rows += `
                        <tr>
                            ...
                            <td class="text-center d-flex">
                                ...
                                <a href="#" class="ms-2 p-2 fs-6 my_icons projectUpdatedocPM edit-action" data-bs-toggle="modal" data-bs-target="#update-project-${project.id}" data-id="${ project.id }">
                ...
                // <form action="/resource/projects/index/${project.id}/trash" method="POST" onsubmit="return confirm('Are you sure you want to move this Project to trash?');">
                ...
                const newUrl = `${window.location.origin}/resource/projects/index${query.toString() ? `?${query.toString()}` : ''}`;
