...
@section('content')
     ...
     <div class="page-wrapper create_p">
        ...
        <div class="content container-fluid">
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <form action="{{ route('admin.tasks.store') }}" class="needs-validation card" method="POST">
                        @csrf
                        <h4>Task Details</h4>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                ...
                                <input id="start_date" class="form-control" style="text-transform: uppercase;" type="date" name="start_date" value="{{ old('start_date') }}" required placeholder="MM/DD/YYYY">
                            </div>
            
                            <div class="col-sm-4">
                                <label class="col-form-label">End Date<span class="text-danger">*</span></label>
                                <input id="end_date" class="form-control" style="text-transform: uppercase;" type="date" name="end_date" value="{{ old('end_date') }}" required placeholder="MM/DD/YYYY">
                            </div>
                            <div class="col-sm-4">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        createMilestoneLink.innerHTML = `<a href="/admin/projects/milestonecreate" style="color: blue; text-decoration: underline;">Create a new milestone</a>`;
        ...
        projectSelect.addEventListener("change", function() {
            ...
            if (projectId) {
                ...
                fetch(`/admin/tasks/${projectId}/milestones`)
