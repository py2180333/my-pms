        ...
        <div class="content container-fluid">
                    ...
                    <div class="col text-end">
                        <ul class="list-inline-item ps-0">
                            <li class="list-inline-item">
                                    ...
                                    id="add-task" href="{{route('admin.assigntask.create')}}">Assign Task</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="crms-title row bg-white mb-4">
                <div class="col-12 d-flex gap-1">
                    <!-- Project Filter -->
                    <select id="project-filter-at-task" class="form-select form-select-sm " style="width: 140px;">
                    ...
                    <!-- Milestone Filter -->
                    <select id="milestone-filter-at-task" class="form-select form-select-sm" style="width: 140px;">
                         <!-- Option will be inserted here via AJAX -pr -->
                    </select>  
                    <!-- Task Filter -->
                    <select id="task-filter-at-task" class="form-select form-select-sm" style="width: 140px;">
                        <!-- Option will be inserted here via AJAX -pr -->
                    </select>
                    <!-- Resource Filter -->
                    <select id="resource-filter-at-task" class="form-select form-select-sm" style="width: 140px;">
                        <!-- Option will be inserted here via AJAX -pr -->
                    </select>
                    <!-- Status Filter -->
                    <select id="status-filter-at-task" class="form-select form-select-sm" style="width: 140px;">
                                    ...
                                    <tbody id="assigntasks-data">
                                        ...
                                        {{--@foreach ($assigntasks as $assigntask)
                                            <tr>
                                                ...
                                                <td>{{ $assigntask->consultant->first_name ?? $assigntask->project->manager->first_name}} {{ $assigntask->consultant->last_name ?? $assigntask->project->manager->last_name}}</td> <!-- pranav -->
                                                ...
                                                <td class="text-center d-flex">
                                                    <!-- <a href="#" class="ms-2 p-2 fs-6 my_icons"><i class="fa-solid fa-pen-to-square text-dark" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"></i></a> -->
                                                    <a href="#" class="ms-2 p-2 fs-6 my_icons edit-action" data-bs-toggle="modal" data-bs-target="#task-update-{{$assigntask->id}}"><i class="fa-solid fa-pen-to-square text-dark" data-bs-placement="top" title="Edit"></i></a> <!-- pranav -->
                                                    ...
                                                    <form action="{{ url('admin/delete-assigned-task/'.$assigntask->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete Task?');"> <!-- pranav -->
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        <div class="task-infos">
                            <div class="tab-content">
                                <div class="content container-fluid">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12">
                                            <form action="{{ route('admin.assigntask.index.update', $assigntask->id) }}" method="POST">
                                                @csrf
                                                @method('PATCH')
...
@endsection
@section('script')
<script src="{{asset('/assets/js/assigntaskview.js')}}"></script> <!-- pr -->
