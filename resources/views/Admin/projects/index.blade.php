...
@section('content')
            ...
            <div class="crms-title row bg-white">
                ...
                <div class="col p-0 text-end">
                    <ul class="breadcrumb bg-white float-end m-0 ps-0 pe-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li> {{-- route('admin.dashboard') -pr --}}
 ...
 <!-- Page Header -->
                    ...
                    <div class="col text-end">
                        <ul class="list-inline-item ps-0">
                            <li class="list-inline-item">
                                <a class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" href="{{route('admin.projects.trash')}}">All Trash</a>
           ...
           <div class="crms-title row bg-white mb-4">
             <div class="col-12 ">
                <ul class="app-listing justify-content-start filter-data m-0 p-0">
                    <!-- Company Filter -->
                    <li>
                        <div class="multipleSelection m-0">
                            <select id="company-filter-project" class="form-select">
                                ...
                                <div class="content container-fluid">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12">
                                            ...
                                            <form action="{{ route('admin.projects.index.update', $project->id) }}" method="POST" id="updateprojectdetails" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-control form-select js-states single" name="vendor_id">
                                                            <option value="">Select Vendor</option>
                                                            @foreach($vendors as $vendor)
                                                                <option value="{{ $vendor->id }}" 
                                                                    {{ old('vendor_id', $project->vendor_id) == $vendor->id ? 'selected' : '' }}>
                                                                    {{ $vendor->email }}
                                                                </option>
                                                            @endforeach
                                                        </select>                                                        
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-control js-states single" name="project_manager_id">
                                                            <option value="">Select Project Manager</option>
                                                            @foreach($resources as $resource)
                                                                <option value="{{ $resource->id }}" 
                                                                    {{ old('project_manager_id', $project->project_manager_id) == $resource->id ? 'selected' : '' }}>
                                                                    {{ $resource->email }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <ul class="list-inline-item ps-0">
                                        <li class="list-inline-item">
                                            <a class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded"
                                                href="#" 
                                                data-url="{{ route('admin.projects.milestone.trashed', $project->id) }}" 
                                                data-bs-toggle="modal" 
                                                data-bs-target="#mailstone-user-deleted"
                                                onclick="trashedMilestone(event); this.blur();">All Trash</a> <!-- pr -->
                                            <a class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded"
                                                href="{{route('admin.projects.milestonecreate')}}">New Milestone</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center d-flex">
                                                                            ...
                                                                            @if (!is_null($milestone->document))
                                                                                ...
                                                                                @else
                                                                                    <a href="{{route('admin.projects.milestone.invoice',$milestone->id)}}" class="ms-2 p-2 fs-6 my_icons milestone-base">
                                                                                @endif
                                                                            ...
                                                                            <form action="{{ route('admin.projects.milestone.destroy', $milestone->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to move this milestone to trash?');">
                                                                                @csrf
                                                                                @method('DELETE')
    ...
    <!--show all deleted milestone project wise -pr -->
                                    ...
                                    <div class="table-responsive milestone-table-scroller">
                                            ...
                                            <table class="table table-striped table-nowrap custom-table mb-0 datatable milestone-table">
                                                ...
                                                <tbody id="trashed-milestones-container">
                                                    <!-- Loaded dynamically via JS in below script -pr -->
                                                </tbody>
                                            </table>
    ...
    <!--/show all deleted milestone project wise end -pr -->
    ...
    @foreach ($projects as $project)
        @foreach ($project->milestones as $milestone)
            <div class="modal right fade" id="update-milestone-{{$milestone->id}}" 
                                    ...
                                    {{-- <div class="col text-end">
                                        <ul class="list-inline-item ps-0">
                                            <li class="list-inline-item">
                                                ...
                                                <a class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded"
                                                    href="../template/create_project.html">New Mailstone</a>
                                            </li>
                                        </ul>
                                    </div> --}}
                                </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <form action="{{ route('admin.projects.milestone.update', $milestone->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="row mb-3">
                                <div class="col-md-6">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="content container-fluid">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <form action="
                                        {{ route('admin.projects.milestone.doc.docupload', $milestone->id) }}
            ...
            milestones.forEach((milestone, index) => {
                container.innerHTML += `
                    <tr>
                        ...
                        <td class="text-center">${ milestone.amount }</td>
                        <td class="text-center d-flex">
                            <form action="/admin/projects/milestone/${milestone.id}/restore" method="POST" onsubmit="return confirm('Do you want to restore this milestone?');">
                                @csrf
                            ...
                            <form action="/admin/projects/milestone/${milestone.id}/force-delete" method="POST" onsubmit="return confirm('Do you want to permanent delete this milestone?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="ms-2 p-2 fs-6 my_icons btn btn-link text-danger delete-action">
...
@endsection
@section('script')
<script src="{{asset('/assets/js/projectview.js')}}"></script> <!-- pr -->
