...
<div class="page-wrapper milnewpopup create_p">
    ...
    <div class="content container-fluid">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <form action="{{ route('resource.milestones.store') }}" class="needs-validation card" method="POST">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label class="form-label">Project Name<span class="text-danger">*</span></label>
                            <select class="form-select form-control" id="projectselectmilPM" required name="project_id"> <!-- projectselectmilPM change -pr 22-7-25 -->
