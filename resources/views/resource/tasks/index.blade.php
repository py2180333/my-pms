 ...
 <!-- Page Header -->
                        ...
                        <div class="col text-end">
                            <ul class="list-inline-item ps-0">
                                <li class="list-inline-item">
                                        ...
                                        <a class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded"
                                        id="add-task" href="{{ route('resource.tasks.create') }}">New Task</a>
                                </li>
                            </ul>
                        </div>
                    </div>
              ...
              <div class="crms-title row bg-white mb-4">
                  <div class="d-flex flex-wrap align-items-center gap-2">
                    ...
                    <!-- Project Filter -->
                    <select id="project-filter-task" class="form-select" style="width: 140px;">
                    ...
                    <!-- Milestone Filter -->
                    <select id="milestone-filter-task" class="form-select " style="width: 160px;">
                        <!-- Option will be inserted here via AJAX -pr -->
                    </select>

                    <!-- if no milestone is available of selected project -->
                    <div id="no-milestone">
                        <!-- <a href="/resource/projects/milestonecreate" style="color: blue; text-decoration: underline;">Create a new milestone</a> -->
                    </div>

                    <!-- Priority Filter -->
                    <select id="priority-filter-task" class="form-select " style="width: 140px;">
                    ...
                    <!-- Status Filter -->
                    <select id="status-filter-task" class="form-select " style="width: 140px;">
                                        ...
                                        @foreach ($tasks as $task)
                                            <tr>
                                                ...
                                                <td class="text-center d-flex">
                                                    ...
                                                    <!-- @if(Auth::guard('resource')->user()->role == "project_manager")
                                                        <form action="{{ route('resource.tasks.force-delete', $task->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete Task?');">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    <div class="task-infos">
                        <div class="tab-content">
                            <div class="content container-fluid">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <form action="{{ route('resource.tasks.index.update', $task->id) }}" 
...
@section('script')
@if(Auth::guard('resource')->user()->role == "project_manager")
<script src="{{asset('/assets/js/resources/taskview.js')}}"></script>
