			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu notifications">
						...
						<div class="topnav-dropdown-footer">
							<a href="{{ route('resource.viewNotification') }}">View all Notifications</a>
						</div>
					</div>
				</li>
        		<!-- /Notifications -->
				...
				<li class="nav-item dropdown has-arrow main-drop">
					<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
						...
						@php
							if(Auth::user()->profile_picture)
								$image = asset('uploads/resources/' . Auth::user()->profile_picture);
							else
								$image = asset('/assets/img/user_profile.png');
						@endphp
						<span class="user-img">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{route('resource.profiles')}}">My Profile</a>
						<form action="{{ route('resource.logout') }}" method="POST" style="display: inline;">
							@csrf
							<button type="submit" id="myCheck" class="dropdown-item">Logout</button>
						</form>
					</div>
				</li>
			</ul>	
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/utils.js"></script>
	...
	<!-- new pr 12-8-25 -->
	<!-- notification -->
	<script src="{{ asset('/assets/js/resources/notification.js') }}"></script>
